...
public class polymart {
    ...
    public static void setLicense() {
        ...
        plugin.sendConsole(plugin.prefix + "&cTo get a license please first verify as buyer on our discord and visit https://dashboard.artzstudio.dev/ for get a license.");
        plugin.sendConsole(plugin.prefix);
        plugin.sendConsole(plugin.prefix + "&c-> Our discord:");
        plugin.sendConsole(plugin.prefix + "&chttps://artzstudio.dev/discord");
        plugin.sendConsole(plugin.prefix);
        plugin.sendConsole(plugin.prefix + "&c############## WARNING ##############");
        plugin.sendConsole("");
