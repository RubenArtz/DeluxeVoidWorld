...
public class sendBossBar {
    ...
    public static void sendBoss(final Player player, YamlDocument file, String pathColor, String pathMessage) {
    ...
    private static BossBar.Color getBarColor(YamlDocument file, String pathFile) {
