...
public class polymart {
    ...
    public static void setLicense() {
        ...
        plugin.sendConsole(plugin.prefix + "&cTo get a license please first verify as buyer on our discord and visit https://panel.stn-studios.dev/ for get a license.");
        plugin.sendConsole(plugin.prefix);
